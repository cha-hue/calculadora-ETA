...
st.set_page_config(page_title="ETA Calculator Manual ⏱️", layout="wide")
st.title("ETA Calculator Manual ⏱️")
...
with st.sidebar.form("eta_form"):
    ...
    distancia = st.number_input("Distancia restante (millas)", min_value=1, help="Ingresar manualmente")
